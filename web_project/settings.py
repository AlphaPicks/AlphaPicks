...
Generated by 'django-admin startproject' using Django 3.1.dev20191121095405.
...
# Build paths inside the project like this: BASE_DIR / 'subdir'.sss
...
SECRET_KEY = 'o+8o2wz1bx+=$wu*k9eew(_^nb2)t_=rfur0*=mv_*9uds4r_v'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['198.211.99.20', 'localhost', '127.0.0.1', "alphapicks.es"]
